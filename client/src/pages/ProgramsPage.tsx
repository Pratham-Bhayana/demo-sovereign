...
// Program data for different regions, aligned with programsData
const programs = {
  caribbean: [
    {
      id: "stkitts",
  ...
  return (
    <>
      ...
      <section className="relative bg-[#183B4E] from-primary to-secondary py-24 md:py-32">
        <div className="absolute inset-0 bg-cover bg-center opacity-10" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1562619371-b67725b6fde2?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80')" }}></div>
